"""
Trainer Chat API route - DeepSeek AI integration with quota enforcement
"""
...
from app.schemas.trainer import TrainerChatRequest, TrainerChatResponse
...
async def chat_with_trainer(
    ...
    try:
        ...
        # Step 3: Get AI response from DeepSeek
        try:
            ai_reply = await ai_service.get_ai_response(request.message)
        except Exception as e:
